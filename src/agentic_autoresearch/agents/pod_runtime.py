...
def render_template(template_text: str, params: dict) -> dict:
    ...
    DOMAIN_DEFAULTS_NUMERIC = {
        ...
        "detailer_denoise_pass1": 0.5,
        "detailer_denoise_pass2": 0.3,
        "detailer_steps":     20,
        "detailer_steps_pass1": 20,
        "detailer_steps_pass2": 20,
        "detailer_cfg":       1.0,
        "detailer_id_weight": 1.0,
        "detailer_id_weight_pass1": 1.0,
        "detailer_id_weight_pass2": 1.05,
        "face_crop_size":     1024,
        "facedetailer_crop_size": 1024,
        "face_crop_size_pass1": 1024,
        "face_crop_size_pass2": 1024,
